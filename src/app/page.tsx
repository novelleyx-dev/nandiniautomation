    ...
    <div className="bg-white text-slate-800 min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              <div className="inline-flex items-center space-x-2 bg-blue-50 border border-blue-200 px-3.5 py-1.5 rounded text-xs font-mono font-bold text-[#0f4c81]">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-slate-900 font-outfit leading-[1.15]">
                ...
                <span className="bg-gradient-to-r from-[#0f4c81] via-[#2b6cb0] to-blue-600 bg-clip-text text-transparent">
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                <a href="#products" className="px-6 py-3 bg-[#0f4c81] hover:bg-blue-700 text-white font-bold rounded shadow-sm hover:shadow transition-all text-sm uppercase tracking-wider">
                  Explore Solutions
                </a>
                <a href="#rfq-section" className="px-6 py-3 bg-white hover:bg-slate-50 text-slate-700 font-bold rounded border border-slate-200 transition-all text-sm uppercase tracking-wider">
              ...
              <div className="pt-8 border-t border-slate-200 grid grid-cols-2 sm:grid-cols-4 gap-4 text-xs font-mono">
                <div>
                  <span className="block text-blue-700 font-bold">CPRI TESTED</span>
                  <span className="text-slate-500 text-[10px]">Busbars certified</span>
                </div>
                <div>
                  <span className="block text-blue-700 font-bold">33KV ELECTRICAL LICENSE</span>
                  <span className="text-slate-500 text-[10px]">Government approved</span>
                </div>
                <div>
                  <span className="block text-blue-700 font-bold">YASKAWA Authorized</span>
                  <span className="text-slate-500 text-[10px]">Warranty center</span>
                </div>
                <div>
                  <span className="block text-blue-700 font-bold">ABB CHANNEL PARTNER</span>
            ...
            <div className="lg:col-span-5 relative">
              <div className="relative mx-auto w-full max-w-[420px] aspect-[4/5] bg-white border border-slate-200 rounded-lg overflow-hidden shadow-xl hover:shadow-2xl transition-shadow duration-300">
                ...
                <div className="absolute bottom-4 left-4 right-4 bg-white/95 backdrop-blur border border-slate-200/80 rounded p-4 shadow-lg font-mono text-[10px] space-y-1">
                  <div className="flex justify-between items-center text-[#0f4c81] font-bold">
      ...
      <section className="bg-white py-16 relative border-b border-slate-200/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div className="bg-[#f7f9fc] border border-slate-200/80 p-6 rounded hover:shadow-sm transition-all">
              <p className="text-4xl sm:text-5xl font-extrabold text-slate-900 font-outfit mb-2 tracking-tight">
                {stats.years}+
              </p>
              <p className="text-xs uppercase tracking-widest text-[#0f4c81] font-bold font-mono">
                Years of Excellence
              </p>
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white border border-slate-200/80 p-8 rounded shadow-sm hover:shadow transition-shadow relative overflow-hidden group">
              <div className="absolute top-0 left-0 w-full h-[3px] bg-[#0f4c81]" />
              <h3 className="text-slate-900 font-bold text-lg mb-4 font-outfit">ISO 9001:2015 Registered</h3>
            ...
            <div className="bg-white border border-slate-200/80 p-8 rounded shadow-sm hover:shadow transition-shadow relative overflow-hidden group">
              <div className="absolute top-0 left-0 w-full h-[3px] bg-[#0f4c81]" />
              <h3 className="text-slate-900 font-bold text-lg mb-4 font-outfit">CPRI Busbar Certification</h3>
            ...
            <div className="bg-white border border-slate-200/80 p-8 rounded shadow-sm hover:shadow transition-shadow relative overflow-hidden group">
              <div className="absolute top-0 left-0 w-full h-[3px] bg-[#0f4c81]" />
              <h3 className="text-slate-900 font-bold text-lg mb-4 font-outfit">A-Grade 33KV Gov Electrical License</h3>
              <p className="text-sm text-slate-655 leading-relaxed">
      ...
      <section id="industries" className="py-20 relative bg-[#f7f9fc] border-b border-slate-200/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-xs uppercase tracking-widest text-[#0f4c81] font-mono font-bold mb-3">
              EPC Sectors & Markets
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {INDUSTRIES.slice(0, 8).map((industry) => (
              <div 
                ...
                className="bg-white border border-slate-200 rounded overflow-hidden cursor-pointer shadow-sm hover:shadow-md transition-all duration-305 flex flex-col justify-between group"
              >
                ...
                <div className="p-5 flex-grow flex flex-col justify-between">
                  ...
                  <div className="flex justify-between items-center text-[10px] font-mono text-slate-400 pt-3 border-t border-slate-100">
                    ...
                    <span className="text-[#0f4c81] font-bold group-hover:underline">CASE DATA &rarr;</span>
                  </div>
                </div>
              </div>
            ))}
              ...
              <button
                ...
                className={`px-6 py-3.5 font-bold text-xs tracking-wider uppercase font-mono border-b-2 transition-all ${
                  activeProductTab === index
                    ? 'border-[#0f4c81] text-[#0f4c81] bg-slate-50'
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <span className="text-[9px] uppercase font-mono text-[#0f4c81] bg-blue-50 px-2.5 py-1 rounded border border-blue-200/60 font-bold">
                      SPECS SHEET
                    </span>
                  </div>
                ...
                <div className="border-t border-slate-200 pt-4 flex justify-between items-center text-[10px] font-mono text-slate-400 relative z-10">
                  ...
                  <span className="text-[#0f4c81] font-bold group-hover:underline">Open Data sheet &rarr;</span>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {PROJECTS.map((project, idx) => (
              ...
              >
                <div className="absolute top-0 left-0 w-[4px] h-full bg-[#cbd5e1] group-hover:bg-[#0f4c81] transition-colors" />
                ...
                <div className="border-t border-slate-100 pt-4 flex justify-between items-center text-[10px] font-mono">
                  ...
                  <span className="text-[#0f4c81] font-bold group-hover:underline">CASE REPORT &rarr;</span>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
              ...
              {WORKFLOW.map((item, idx) => (
                <button
                  ...
                  className={`flex flex-col items-center text-center p-3 rounded transition-all focus:outline-none ${
                    activeWorkflow === idx
                      ? 'bg-white border border-[#0f4c81]/30 shadow-sm'
                ...
                >
                  ...
                  <span className={`text-[10px] uppercase font-mono tracking-wider font-bold ${
                    activeWorkflow === idx ? 'text-[#0f4c81]' : 'text-slate-400'
                  }`}>
                    {item.step}
                  </span>
                </button>
          ...
          <div className="bg-[#f7f9fc] border border-slate-200 p-8 rounded-lg flex flex-col md:flex-row md:items-center justify-between gap-8">
            <div className="space-y-4 max-w-xl">
              <span className="text-[10px] font-mono text-[#0f4c81] uppercase tracking-widest border border-blue-200 bg-blue-50 px-2.5 py-0.5 rounded font-bold">
            ...
            <div className="flex-shrink-0">
              <svg className="w-32 h-32 text-blue-700/10" viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="1.5">
                ...
                <circle cx="50" cy="50" r="8" className="fill-[#0f4c81] stroke-blue-400" />
              </svg>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6 space-y-6">
              <div className="inline-block bg-blue-50 border border-blue-200 px-3 py-1 rounded font-mono text-xs text-[#0f4c81] uppercase tracking-wider font-bold">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={idx} className="flex items-start space-x-3">
                    <span className="w-2.5 h-2.5 bg-[#0f4c81] rounded-full mt-1.5 shrink-0" />
                    <div>
            ...
            <div className="lg:col-span-6">
              <div className="bg-white border border-slate-200 rounded-lg p-8 space-y-6 font-mono text-xs shadow-md">
                <div className="flex justify-between items-center border-b border-slate-100 pb-4">
                  <span className="text-[#0f4c81] font-bold uppercase tracking-wider">EMERGENCY RESPONSE PROTOCOL</span>
      ...
      <section className="py-16 bg-white border-b border-slate-200/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-xs uppercase tracking-widest text-[#0f4c81] font-mono font-bold mb-10">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-6">
            {[
              ...
              >
                <span className="text-[#0f4c81] font-extrabold text-lg tracking-widest font-mono group-hover:text-blue-700 transition-colors">
                  {partner.name}
                </span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {CERTIFICATIONS.map((cert, index) => (
              ...
              >
                <div>
                  <div className="w-8 h-8 rounded bg-blue-50 border border-blue-200 flex items-center justify-center text-[#0f4c81] font-bold mb-4 font-mono text-xs">
                    0{index + 1}
                  </div>
      ...
      <section id="about" className="py-20 relative bg-white border-b border-slate-200/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6 space-y-6">
              <span className="text-xs uppercase tracking-widest text-[#0f4c81] font-mono font-bold">
              ...
              <div className="grid grid-cols-2 gap-4 font-mono text-xs">
                <div className="bg-[#f7f9fc] p-4 rounded border border-slate-200">
                  <span className="block text-[#0f4c81] font-bold mb-1">CHERLAPALLY PLANT</span>
                ...
                <div className="bg-[#f7f9fc] p-4 rounded border border-slate-200">
                  <span className="block text-[#0f4c81] font-bold mb-1">ENGINEERING TEAM</span>
            ...
            <div className="lg:col-span-6">
              <div className="space-y-6 bg-[#f7f9fc] border border-slate-200 rounded-lg p-8 shadow-sm">
                <div>
                  <h3 className="text-[#0f4c81] font-bold text-sm uppercase tracking-wider mb-2 font-mono">
                    OUR CORE MISSION
                  </h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left font-mono text-xs">
            <div className="bg-[#f7f9fc] border border-slate-200 rounded-lg p-6 hover:border-blue-300 shadow-sm transition-all">
              ...
              <span className="text-[#0f4c81] font-bold cursor-pointer" onClick={() => alert("Loading mock video stream: Yaskawa A1000 load test (220kW)...")}>
            ...
            <div className="bg-[#f7f9fc] border border-slate-200 rounded-lg p-6 hover:border-blue-300 shadow-sm transition-all">
              ...
              <span className="text-[#0f4c81] font-bold cursor-pointer" onClick={() => alert("Loading layout schematic schematic_HMWSSB_v1.2.pdf...")}>
            ...
            <div className="bg-[#f7f9fc] border border-slate-200 rounded-lg p-6 hover:border-blue-300 shadow-sm transition-all">
              ...
              <a 
                ...
                className="text-[#0f4c81] font-bold hover:underline block"
                onClick={(e) => {
                  e.preventDefault();
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              <div className="bg-white border border-slate-200 rounded-lg p-6 font-mono text-xs space-y-4 shadow-sm">
                ...
                <div className="flex items-center space-x-3 text-slate-600">
                  <span className="text-[#0f4c81] font-bold w-24">Sales RFQ:</span>
                  <span>info@nandiniautomation.com</span>
                </div>
                <div className="flex items-center space-x-3 text-slate-600">
                  <span className="text-[#0f4c81] font-bold w-24">Drive Desk:</span>
                  <span>+91-40-23190131</span>
                </div>
                <div className="flex items-center space-x-3 text-slate-600">
                  <span className="text-[#0f4c81] font-bold w-24">Location:</span>
            ...
            <div className="lg:col-span-7 bg-white border border-slate-200 p-8 rounded-lg shadow-md">
              ...
              {rfqSubmitted ? (
                ...
                <form onSubmit={handleInquirySubmit} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    className="w-full py-3 bg-gradient-to-r from-[#0f4c81] to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-bold rounded text-xs uppercase tracking-wider transition-colors"
                  >
          ...
          <div className="bg-white border border-slate-200 rounded-lg max-w-2xl w-full p-8 shadow-2xl relative text-slate-700 font-sans">
            ...
            <div className="space-y-6 text-sm text-slate-600">
              ...
              <div>
                ...
                <p className="text-xs text-[#0f4c81] font-mono font-bold">{selectedProduct.standards}</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white border border-slate-200 rounded-lg max-w-2xl w-full p-8 shadow-2xl relative text-slate-700 font-sans">
            ...
            <div className="space-y-6 text-sm text-slate-650">
              ...
              <div>
                ...
                <p className="text-xs font-mono text-[#0f4c81] font-bold">{selectedProject.tech}</p>
              </div>
          ...
          <div className="bg-white border border-slate-200 rounded-lg max-w-md w-full p-8 shadow-2xl relative text-slate-700 font-sans">
            ...
            <div className="space-y-6 text-sm text-slate-600">
              <div className="bg-[#f7f9fc] border border-slate-200 p-6 rounded text-center font-mono">
                ...
                <div className="w-16 h-16 border-2 border-blue-200 border-dashed rounded-full flex items-center justify-center mx-auto mt-6 text-[#0f4c81] text-lg font-bold">
                  ISO
                </div>
              </div>
              ...
              <div className="pt-4 border-t border-slate-200 flex justify-between items-center text-xs">
                ...
                <button 
                  className="px-3.5 py-2 bg-slate-100 hover:bg-slate-200 text-[#0f4c81] rounded font-bold transition-colors text-xs"
