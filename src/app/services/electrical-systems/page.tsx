          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
            ...
            <div className="lg:col-span-4 space-y-8">
              ...
              <div className="bg-[#E8F0FA] p-8 rounded-2xl border border-slate-200 shadow-sm">
                ...
                <ul className="space-y-4 font-mono text-sm text-slate-700">
                  <li className="flex items-start gap-3">
                    <UtilityPole className="w-5 h-5 text-[var(--color-ne-blue-steel)] shrink-0" />
                    <span>33KV / 11KV Substation Setup</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <Cable className="w-5 h-5 text-[var(--color-ne-blue-steel)] shrink-0" />
                    <span>HT & LT Cable Routing & Termination</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <PowerOff className="w-5 h-5 text-[var(--color-ne-blue-steel)] shrink-0" />
                    <span>Power Transformers & Switchgears</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <ShieldAlert className="w-5 h-5 text-[var(--color-ne-blue-steel)] shrink-0" />
              ...
              <div className="bg-gradient-to-br from-[var(--color-ne-blue-corp)] to-[var(--color-ne-blue-steel)] p-8 rounded-2xl text-white shadow-xl">
                <h4 className="text-2xl font-bold font-outfit mb-4">Secure Your Power Supply</h4>
