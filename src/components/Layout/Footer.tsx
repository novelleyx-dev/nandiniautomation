  ...
  return (
    <footer className="bg-slate-900 text-slate-300 border-t border-slate-200 font-sans relative overflow-hidden">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-50 bg-green-600 hover:bg-green-700 text-white p-3 rounded-full shadow-lg flex items-center justify-center hover:scale-110 transition-transform duration-300 group"
      >
        ...
        <span className="absolute right-full mr-2 bg-slate-900 border border-slate-800 text-[10px] text-white px-2 py-1 rounded shadow opacity-0 group-hover:opacity-100 transition-opacity font-mono tracking-wider whitespace-nowrap">
          Talk to an Engineer
        </span>
      </a>
    </footer>
