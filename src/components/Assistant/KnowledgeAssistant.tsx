  ...
  return (
    <div className="fixed bottom-6 right-6 z-[60] font-sans">
      ...
      {!isOpen && (
        <button
          onClick={toggleAssistant}
          className="bg-white hover:bg-slate-50 text-[var(--color-ne-blue-corp)] border border-slate-200 w-12 h-12 rounded-full shadow-lg hover:shadow-xl flex items-center justify-center hover:scale-105 transition-all duration-300 relative group"
        >
